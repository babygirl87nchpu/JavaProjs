...
public class DABGameTest {
    ...
    /**
     * Testing method size before initializing grid
     */
    @Test(expected = GameException.class)
    public void testCallSizeBeforeIntGame() {
        game.getSize();
    }

    /**
     * Testing method getDrawnEdgesAt before initializing grid
     */
    @Test(expected = GameException.class)
    public void testCallDrawnEdgsAtBeforeIntGame() {
        game.getDrawnEdgesAt(new Coordinate(0, 0));
    }

    /**
     * Testing method getDrawnEdgesAt with invalid coordinates.
     */
    @Test(expected = GameException.class)
    public void testCallDrawnEdgsAtInvalidCoordsGame() {
        game.init(2);
        game.getDrawnEdgesAt(new Coordinate(-1, -1));
    }

    /**
     * Testing method getOwnerAt before initializing grid
     */
    @Test(expected = GameException.class)
    public void testCallGetOwnerAtBeforeIntGame() {
        game.getOwnerAt(new Coordinate(0, 0));
    }

    /**
     * Testing method getOwnerAt with invalid coordinates.
     */
    @Test(expected = GameException.class)
    public void testCallGetOwnerAtInvalidCoordsGame() {
        game.init(2);
        game.getOwnerAt(new Coordinate(-1, -1));
    }
    ...
    /**
     * Testing method draw edge before initializing grid
     */
    @Test(expected = GameException.class)
    public void testCallDrawEdgeBeforeIntGame() {
    ...
    public void testScoreAtTwoByTwoGrid() {
        ...
        assertNull(game.getCurrentPlayer());// game over current player is null
    }
}
